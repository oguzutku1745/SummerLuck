...
const frameHandler = frames(async (ctx) => {
  ...
  if (ctx.message?.transactionId) {
    return {
      image: (`${"https://summer-luck.vercel.app/customized/custom-2"}/transaction_submitted.png`),
      imageOptions: {
        width: 100,
        height: 100,
      },
  ...
  if (page === "initial") {
    return {
      image: (`${"https://summer-luck.vercel.app/customized/custom-2"}/entrance.png`),
      imageOptions: {
        width: 100,
        height: 100,
      },
  ...
  if (message) {
    const imageUrl = followState 
      ? `${"https://summer-luck.vercel.app/customized/custom-2"}/follow_true.png` 
      : `${"https://summer-luck.vercel.app/customized/custom-2"}/follow_false.png`;
  ...
  return {
    image: `${"https://summer-luck.vercel.app/customized/custom-2"}/error.png`,
    buttons: [
