...
const frameHandler = frames(async (ctx) => {
  ...
  const casterName = process.env.testCaster;
  let signature;
  ...
  if (ctx.message?.transactionId) {
    return {
      image: (`${process.env.http://summer-luck.vercel.app/customized/custom-2}/transaction_submitted.png`),
      imageOptions: {
        width: 100,
        height: 100,
      },
  ...
  if (page === "initial") {
    return {
      image: (`${process.env.http://summer-luck.vercel.app/customized/custom-2}/entrance.png`),
      imageOptions: {
        width: 100,
        height: 100,
      },
  ...
  if (message) {
    const imageUrl = followState 
      ? `${process.env.http://summer-luck.vercel.app/customized/custom-2}/follow_true.png` 
      : `${process.env.http://summer-luck.vercel.app/customized/custom-2}/follow_false.png`;
  ...
  return {
    image: `${process.env.http://summer-luck.vercel.app/customized/custom-2}/error.png`,
    buttons: [
