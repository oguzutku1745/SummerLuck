...
const frameHandler = frames(async (ctx) => {
  ...
  if (ctx.message?.transactionId) {
    return {
      image: (`${"http://summer-luck.vercel.app/customized/custom-2"}/transaction_submitted.png`),
      imageOptions: {
        width: 100,
        height: 100,
      },
  ...
  if (page === "initial") {
    return {
      image: (`${"http://summer-luck.vercel.app/customized/custom-2"}/entrance.png`),
      imageOptions: {
        width: 100,
        height: 100,
      },
  ...
  if (message) {
    const imageUrl = followState 
      ? `${"http://summer-luck.vercel.app/customized/custom-2"}/follow_true.png` 
      : `${"http://summer-luck.vercel.app/customized/custom-2"}/follow_false.png`;
  ...
  return {
    image: `${"http://summer-luck.vercel.app/customized/custom-2"}/error.png`,
    buttons: [
