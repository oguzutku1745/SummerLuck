...
const frameHandler = frames(async (ctx) => {
  ...
  if (ctx.message?.transactionId) {
    return {
      image: (`${process.env.http://summer-luck.vercel.app/customized/custom-4}/transaction_submitted.png`),
      imageOptions: {
        width: 100,
        height: 100,
      },
  ...
  if (page === "initial") {
    return {
      image: (`${process.env.http://summer-luck.vercel.app/customized/custom-4}/entrance.png`),
      imageOptions: {
        width: 100,
        height: 100,
      },
  ...
  if (message) {
    const imageUrl = followState 
      ? `${process.env.http://summer-luck.vercel.app/customized/custom-4}/follow_true.png` 
      : `${process.env.http://summer-luck.vercel.app/customized/custom-4}/follow_false.png`;
  ...
  return {
    image: `${process.env.http://summer-luck.vercel.app/customized/custom-4}/error.png`,
    buttons: [
